...
from .config_omni_base import OmniBaseClientConfig


class OmniBaseClient(Robot):
    config_class = OmniBaseClientConfig
    name = "omni_base_client"

    def __init__(self, config: OmniBaseClientConfig):
        import zmq
    ...
    def _get_data(self) -> tuple[dict[str, np.ndarray], dict[str, Any], dict[str, Any]]:
        ...
        If successful, updates and returns the new frames, and speed.
    ...
    def get_observation(self) -> dict[str, Any]:
        ...
        (converted to body-frame velocities: x, y, theta),
