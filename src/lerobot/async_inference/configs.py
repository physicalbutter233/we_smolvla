...
class RobotClientConfig:
    ...
    display_action_trace: bool = field(
        default=False,
        metadata={
            "help": "Display predicted action chunks, executed actions, and action queue size in real time"
        },
    )
    display_data: bool = field(
        default=False,
        metadata={"help": "Display robot observations, including camera images, in Rerun"},
    )
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "display_action_trace": self.display_action_trace,
